...
public class AboutActivity extends AppCompatActivity {
    ...
    public static final String GITHUB_URL = "https://github.com/CoderEslam";
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            ...
            version.setText(getAppVersionAndBuild(requireActivity()).first);
            ...
            gotToGithub.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    launchWebBrowser(requireActivity(), GITHUB_URL);
